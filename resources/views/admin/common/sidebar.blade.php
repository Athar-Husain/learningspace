<div class="sidebar__area " style="margin-bottom: 20px;">
    ...
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        @endcanany
        @canany(['manage_course_reference', 'manage_course_category', 'manage_course_subcategory', 'manage_course_tag',
        'manage_course_language', 'manage_course_difficulty_level'])
        <li>
            <a class="has-arrow" href="#">
    ...
    <li class="{{ @$navSubscriptionParentActiveClass }}">
        ...
        <ul class="{{ @$navSubscriptionParentShowClass }}">
            ...
            <li
                class="{{ (request()->route()->getName() == "admin.subscriptions.purchase_pending_list") ? 'mm-active' : '' }}">
    ...
    <li class="{{ @$navWalletParentActiveClass }}">
        ...
        <ul class="{{ @$navWalletParentShowClass }}">
            <li
                class="{{ (request()->route()->getName() == "admin.wallet_recharge.pending_list") ? 'mm-active' : '' }}">
    ...
    <li class="">
        ...
        <ul>
            <li
                class="{{ active_if_full_match('admin/report/course-revenue-report') }}{{ active_if_full_match('admin/report/bundle-revenue-report') }}{{ active_if_full_match('admin/report/consultation-revenue-report') }}">
    ...
    @canany(['application_setting', 'global_setting', 'home_setting', 'mail_configuration', 'payment_option',
    'content_setting'])
    ...
    <!-- @can('manage_version_update')
            <li class="{{ @$subNavVersionUpdateActiveClass }}">
                <a href="{{ route('settings.file-version-update') }}">
                    <i class="fa fa-circle"></i>
                    <span>{{__('Current Version Update')}}</span>
                </a>
            </li>
        @endif -->
