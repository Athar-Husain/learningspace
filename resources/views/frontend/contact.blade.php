...
<div class="bg-page">
    <!-- Page Header Start -->
    <header class="bg-white page-banner-header gradient-bg position-relative">
        <div class="section-overlay">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12">
                        <div class="page-banner-content text-center">
                            <h3 class="page-banner-heading text-black pb-15" style="font-weight: 700;">
                                {{ __('Want to Get In Touch?') }}
                            </h3>
                            <h4 class="text-black pb-15">{{ __('Contact Us') }}</h4>

                            <!-- Breadcrumb Start-->
                            <!-- <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item font-14 text-black"><a href="{{ url('/') }}">{{__('Home')}}</a></li>
                                    <li class="breadcrumb-item font-14 text-black active" aria-current="page">
                                        {{ __('Contact Us') }}</li>
                                </ol>
                            </nav> -->
                            <!-- Breadcrumb End-->
    ...
    <section class="contact-page-area section-t-space">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 bg-white contact-page-left-side">
                    ...
                    <div class="contact-page-left-side-wrap">
                        <h5 class="contact-form-title font-24 font-semi-bold">{{ __(get_option('get_in_touch_title')) }}
                        </h5>
                ...
                <div class="col-md-6 col-lg-7 bg-white contact-page-right">
                    <div class="contact-form-area">
                        ...
                        <form id="contact-form">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-30">
                                    <textarea class="form-control message" id="exampleFormControlTextarea1"
                                        rows="3"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
            ...
            <div class="row google-map-area section-t-space">
                <div class="col-12">
                    <iframe src="{{ get_option('contact_us_map_link') }}" style="border:0;" allowfullscreen=""
                        loading="lazy"></iframe>
                </div>
            </div>
            <!-- Google Map Part End-->
