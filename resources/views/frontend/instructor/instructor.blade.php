                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="filter-bar-right col-sm-6 col-md-6 col-lg-6 text-end">
                                <div class="filter-box align-items-center justify-content-end">
                                    ...
                                    <select class="form-select form-select-sm filterSortBy" name="sort_by"
                                        onchange="filterData()">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="sidebar-switch-item d-flex justify-content-between mb-2">
                                            ...
                                            <div class="radio-right-text mx-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" onchange="filterData()"
                                                        type="checkbox" name="available_for_meeting" role="switch"
                                        ...
                                        <div class="sidebar-switch-item d-flex justify-content-between mb-2">
                                            ...
                                            <div class="radio-right-text mx-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" onchange="filterData()"
                                                        type="checkbox" name="free_meeting" role="switch"
                                        ...
                                        <div class="sidebar-switch-item d-flex justify-content-between mb-2">
                                            ...
                                            <div class="radio-right-text mx-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" onchange="filterData()"
                                                        type="checkbox" name="discount_meeting" role="switch"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDifficultyLevel" type="checkbox"
                                                    name="category_ids[]" onclick="filterData()"
                                                    value="{{ $category->id }}" id="exampleRadios{{ $category->id }}">
                                ...
                                <div id="panelsStayOpen-collapseEight" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDifficultyLevel" type="checkbox"
                                                    name="available_type" onclick="filterData()"
                                                    id="exampleRadiosDifficulty9" value="3">
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDifficultyLevel" type="checkbox"
                                                    name="available_type" onclick="filterData()"
                                                    id="exampleRadiosDifficulty10" value="1">
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDifficultyLevel" type="checkbox"
                                                    name="available_type" onclick="filterData()"
                                                    id="exampleRadiosDifficulty11" value="2">
                                ...
                                <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterRating" type="checkbox"
                                                    name="rating[]" onclick="filterData()" id="exampleRadios41"
                                                    value="5">
                                                <label class="form-check-label" for="exampleRadios41">
                                                    <span class="iconify"
                                                        data-icon="bi:star-fill"></span>{{ __('5 star') }}
                                                </label>
                                            </div>
                                            <div class="radio-right-text"></div>
                                        </div>
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterRating" type="checkbox"
                                                    name="rating[]" onclick="filterData()" id="exampleRadios42"
                                                    value="4">
                                                <label class="form-check-label" for="exampleRadios42">
                                                    <span class="iconify"
                                                        data-icon="bi:star-fill"></span>{{ __('4 star or above') }}
                                                </label>
                                            </div>
                                            <div class="radio-right-text"></div>
                                        </div>
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterRating" type="checkbox"
                                                    name="rating[]" onclick="filterData()" id="exampleRadios43"
                                                    value="3">
                                                <label class="form-check-label" for="exampleRadios43">
                                                    <span class="iconify"
                                                        data-icon="bi:star-fill"></span>{{ __('3 star or above') }}
                                                </label>
                                            </div>
                                            <div class="radio-right-text"></div>
                                        </div>
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterRating" type="checkbox"
                                                    name="rating[]" onclick="filterData()" id="exampleRadios44"
                                                    value="2">
                                                <label class="form-check-label" for="exampleRadios44">
                                                    <span class="iconify"
                                                        data-icon="bi:star-fill"></span>{{ __('2 star or above') }}
                                                </label>
                                            </div>
                                            <div class="radio-right-text"></div>
                                        </div>
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterRating" type="checkbox"
                                                    name="rating[]" onclick="filterData()" id="exampleRadios45"
                                                    value="1">
                                                <label class="form-check-label" for="exampleRadios45">
                                                    <span class="iconify"
                                                        data-icon="bi:star-fill"></span>{{ __('1 star or above') }}
                                                </label>
                                            </div>
                                            <div class="radio-right-text"></div>
                                        </div>
                                ...
                                <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="range-value-box">
                                            <div class="range-value-wrap"><label for="price-min">$Min:</label><input
                                                    disabled type="number" min=0 value=0 id="price-min" name="price_min"
                                                    class="price-range-field" /></div>
                                            <div class="range-value-wrap"><label for="price-max">$Max:</label><input
                                                    disabled type="number" max="{{ $priceMax }}" value="{{ $priceMax }}"
                                                    name="price_max" id="price-max" class="price-range-field" /></div>
                                        </div>
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDuration" type="checkbox"
                                                    name="consultation_day[]" onclick="filterData()"
                                                    id="exampleRadiosDuration35" value="0">
                                                <label class="form-check-label"
                                                    for="exampleRadiosDuration35">{{ __('Sunday') }}</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDuration" type="checkbox"
                                                    name="consultation_day[]" onclick="filterData()"
                                                    id="exampleRadiosDuration36" value="1">
                                                <label class="form-check-label"
                                                    for="exampleRadiosDuration36">{{ __('Monday') }}</label>
                                            </div>
                                        </div>
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDuration" type="checkbox"
                                                    name="consultation_day[]" onclick="filterData()"
                                                    id="exampleRadiosDuration37" value="2">
                                                <label class="form-check-label"
                                                    for="exampleRadiosDuration37">{{ __('Tuesday') }}</label>
                                            </div>
                                        </div>
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDuration" type="checkbox"
                                                    name="consultation_day[]" onclick="filterData()"
                                                    id="exampleRadiosDuration38" value="3">
                                                <label class="form-check-label"
                                                    for="exampleRadiosDuration38">{{ __('Wednesday') }}</label>
                                            </div>
                                        </div>
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDuration" type="checkbox"
                                                    name="consultation_day[]" onclick="filterData()"
                                                    id="exampleRadiosDuration39" value="4">
                                                <label class="form-check-label"
                                                    for="exampleRadiosDuration39">{{ __('Thursday') }}</label>
                                            </div>
                                        </div>
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDuration" type="checkbox"
                                                    name="consultation_day[]" onclick="filterData()"
                                                    id="exampleRadiosDuration40" value="5">
                                                <label class="form-check-label"
                                                    for="exampleRadiosDuration40">{{ __('Friday') }}</label>
                                            </div>
                                        </div>
                                        <div class="sidebar-radio-item">
                                            <div class="form-check">
                                                <input class="form-check-input filterDuration" type="checkbox"
                                                    name="consultation_day[]" onclick="filterData()"
                                                    id="exampleRadiosDuration41" value="6">
                                                <label class="form-check-label"
                                                    for="exampleRadiosDuration41">{{ __('Saturday') }}</label>
                                            </div>
                                        </div>
