                        ...
                        <div class="page-banner-content text-center">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    ...
                                    <li class="breadcrumb-item font-14 active" aria-current="page">{{ __('Courses') }}
                                    </li>
                                </ol>
                            </nav>
                            <!-- Breadcrumb End-->
                ...
                <div class="col-md-8 col-lg-9 col-xl-9 show-all-course-area-wrap">
                    <div class="show-all-course-area">
                        ...
                        <div id="loading" class="no-course-found text-center d-none">
                            <div id="inner-status"><img src="{{ asset('frontend/assets/img/loader.svg') }}" alt="img" />
                            </div>
                        </div>
                        <div id="appendCourse">
...
@push('script')
<script>
var paginateRoute = "{{ route('allcourses') }}"
</script>
