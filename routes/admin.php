...
Route::group(['prefix' => 'settings', 'as' => 'settings.'], function () {
    ...
    // Added here 
    // Route::get('bridge-gap-section-settings', function () {
    //     return '<p>fejibfiuwb iubwiuqbd qwdqwiud g </p>';
    // });
    // Route::get('bridge-gap-section-settings', [HomeSettingController::class, 'bridgeGapSection'])->name('bridge-gap-section');
    // Route::post('bridge-gap-section-settings', [HomeSettingController::class, 'bridgeGapSectionUpdate'])->name('bridge-gap-section.update');
    Route::get('bridge-gap-section', [HomeSettingController::class, 'bridgeGapSection'])
        ->name('bridge-gap-section');
    Route::post('bridge-gap-section', [HomeSettingController::class, 'bridgeGapSectionUpdate'])
        ->name('bridge-gap-section.update');

    // Display the course settings form (GET request)
    Route::get('course-form-settings', [HomeSettingController::class, 'courseFormSetting'])
        ->name('course-form-settings');

    // Update the course settings (POST request)
    Route::post('course-form-settings', [HomeSettingController::class, 'courseFormSettingUpdate'])
        ->name('course-form-settings.update');
