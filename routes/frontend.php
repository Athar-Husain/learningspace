...
Route::group(['middleware' => 'private.mode'], function () {
    ...
    Route::get('media-gallery', [MainIndexController::class, 'mediagallery'])->name('media-gallery');
    Route::get('who-we-are', [MainIndexController::class, 'whoweare'])->name('whoweare');
